...
for (i in 1:200){   #We perform bagging 200 times
  ...
  model_random_withInter = lm(as.formula(paste("STAR_ORIGIN ~.+", paste(colnames(chart)[inter_index[1,]],":",colnames(chart)[inter_index[2,]], collapse = " + ", sep = ""))) , data = chart[c(2,trim)])
...
result$Expected = fit_int*0.55+fit_multinom*0.45   #Set the second column of result as "Expected" and store the fitted value into the dataframe
