...
as.formula(paste("STAR ~", paste(colnames(chart)[inter_index[1,]], ":", colnames(chart)[inter_index[2,]], collapse = " + ", sep = "")))
...
test_data = read.csv("test_1519.csv")
