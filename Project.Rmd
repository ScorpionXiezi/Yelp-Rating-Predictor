...
add_predictor = function(data = chart, new_pred, col_name){
...
test_predictor = add_predictor(data = test_predictor, ":\\)", ":)")
test_predictor = add_predictor(data = test_predictor, ";\\)", ";)")
...
test_predictor = add_predictor(data = test_predictor, "five", "five")
test_predictor = add_predictor(data = test_predictor, "\\$", "$")
...
test_predictor = add_predictor(data = test_predictor, "limited", "limited")
test_predictor = add_predictor(data = test_predictor, "plus", "plus")
...
sum(test_predictor[,"plus"])
sum(test_predictor[,"limited"])
...
sum(test_predictor[,"$"])
sum(test_predictor[,"four"])
sum(test_predictor[,"five"])
sum(test_predictor[,":)"])
sum(test_predictor[,";)"])
